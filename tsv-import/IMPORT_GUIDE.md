...
⚠️ **重要な制限**：PostgreSQLは1つのクエリで最大32767個のパラメータしか受け付けません。
- 各レコードは24個のフィールドを使用
- 最大バッチサイズ = 32767 ÷ 24 ≈ 1365レコード
- 安全マージンを考慮して1000をデフォルトに設定
